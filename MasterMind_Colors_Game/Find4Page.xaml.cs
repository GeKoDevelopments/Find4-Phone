...
namespace MasterMind_Colors_Game
{
    public sealed partial class Find4Page : Page
    {
        ...
        public Find4Page()
        {
            ...
            interstitialAd.RequestAd(AdType.Video, "9nblggh1zv29", "1100012389");
        ...
        public void OptionVisible()
        {
            if (Game_Over)
            {
                ...
                OverBoard.Visibility = Visibility.Visible;
            }
            else
            {
                ...
                OverBoard.Visibility = Visibility.Collapsed;
            }
        }
...
private void button_Click(object sender, RoutedEventArgs e)
        {
            But.MediaEnded += (s, en) => Exit_Click();
            But.Play();
        }
    }
}
